...
function ISCraftRecipePanel:createDynamicChildren()
    ...
    self.inputs = ISXuiSkin.build(self.xuiSkin, "S_NeedsAStyle", ISWidgetIngredientsInputs, 0, 0, 10, 10, self.player, self.logic);
    ...
    self.outputs = ISXuiSkin.build(self.xuiSkin, "S_NeedsAStyle", ISWidgetIngredientsOutputs, 0, 0, 10, 10, self.player, self.logic);
    ...
    self.craftControl = ISXuiSkin.build(self.xuiSkin, "S_NeedsAStyle", ISWidgetHandCraftControl, 0, 0, 10, 10, self.player, self.logic);
